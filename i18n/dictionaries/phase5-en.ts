...
export const phase5En = {
  ...
  projects: {
    ...
    eyebrow: 'Our work',
    title: 'Our Work',
    lead: 'Repair stories appear here only with owner and customer consent. We do not invent portfolio work or present placeholders as completed BCS projects.',
    emptyTitle: 'Repair stories in preparation',
    emptyBody:
      'We are preparing approved project stories for publication. Meanwhile, explore how we can help, or request an estimate for your boat.',
    emptyLinksHeading: 'Helpful next steps',
    linkServices: 'How we can help',
    linkEstimate: 'Request an Estimate',
    linkContact: 'Tell Us About Your Project',
    linkResources: 'Resources',
    frameworkTitle: 'How we tell a repair story',
    frameworkBody:
      'Each published project can include what happened, how it was repaired, materials, before / during / after photos, and related services — only with approval and consent.',
    labels: {
      category: 'Category',
      overview: 'Project overview',
      damage: 'What happened',
      repairScope: 'Repair scope',
      process: 'How it was repaired',
      materials: 'Materials',
      finish: 'Finish notes',
      before: 'Before',
      after: 'After',
    ...
    detailEstimateBody:
      'Share photos and boat details to start a marine repair estimate conversation.',
  },
  testimonials: {
